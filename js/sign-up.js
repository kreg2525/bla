// --- CUSTOM DROPDOWN CONTROLLER ---
    ...
    // --- INTERACTIVE PASSWORD EYE TOGGLE CONTROLLER ---
    document.querySelectorAll('.toggle-password-btn').forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            if (targetInput.type === 'password') {
                ...
                // Switches SVG design parameters into "crossed eye hidden line" smoothly
    ...
    // --- LIVE REACTION VALIDATOR AND VERIFIER HINTS ---
    ...
    function liveValidate() {
        // Track Rule 1: Length Validation
        ...
        // Track Rule 2: Passwords Match Validation
    ...
    // --- FORM SUBMIT SECURITY SHAKE CONTROLLER ---
